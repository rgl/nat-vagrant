...
# map an internet exposed TCP port to an internal machine.
# e.g. 10.10.11.254:8001 -> 10.10.10.11:80
for n in $(seq 2); do
    iptables -t nat -A PREROUTING -p tcp --dport $((8000+$n)) -j DNAT --to-destination "10.10.10.$((10+$n)):80"
done
